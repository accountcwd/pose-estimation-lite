...
def pose_flip(meta):
    ...
    # flip meta
    flip_list = [CocoPart.Top, CocoPart.Neck,CocoPart.LShoulder, CocoPart.LElbow, CocoPart.LWrist, 
...
def pose_crop_random(meta):
    ...
    for _ in range(50):
        ...
        for joint in meta.joint_list:
            if x <= joint[CocoPart.RWrist.value][0] < x + target_size[0] and \
                    y <= joint[CocoPart.RWrist.value][1] < y + target_size[1] and \
                    x <= joint[CocoPart.LWrist.value][0] < x + target_size[0] and \
                    y <= joint[CocoPart.LWrist.value][1] < y + target_size[1]:
