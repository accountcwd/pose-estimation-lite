...
parser.add_argument('--inputResW', default=128, type=int,
                    help='Input image width')
parser.add_argument('--outputResH', default=64, type=int,
                    help='Output heatmap height')
parser.add_argument('--outputResW', default=32, type=int,
...
parser.add_argument('--nms', dest='nms_thesh', type=float, default=0.4,
...
parser.add_argument('--video', dest='video',
                    help='video-name', default="./videos/single.mp4")
