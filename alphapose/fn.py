...
def vis_frame_fast(frame, im_res, format='coco'):
    ...
    if format == 'coco':
        ...
        p_color = [PURPLE, BLUE, BLUE, RED, RED, BLUE, RED, RED, RED, PURPLE, PURPLE, PURPLE, RED, RED]
        line_color = [PURPLE, BLUE, BLUE, RED, RED, BLUE, BLUE, RED, RED, PURPLE, PURPLE, RED, RED]
    else:
        NotImplementedError
...
def vis_frame(frame, im_res, format='AIchallenge'):
    '''
    frame: frame image
    im_res: im_res of predictions
    format: coco or mpii
